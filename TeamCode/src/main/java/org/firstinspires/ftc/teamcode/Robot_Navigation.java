...
public class Robot_Navigation
{
    ...
    private static final double  CLOSE_ENOUGH   =  101;      // Within 2.0 cm of final target standoff
    ...
    public double getRobotYAbs(){
        return Math.abs(robotY);
    }
    /***
    ...
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot) {
        ...
        targets.get(0).setName("Stone Target");
        targets.get(1).setName("Blue Rear Bridge");
        targets.get(2).setName("Red Rear Bridge");
        targets.get(3).setName("Red Front Bridge");
        targets.get(4).setName("Blue Front Bridge");
        targets.get(5).setName("Red Perimeter 1");
        targets.get(6).setName("Red Perimeter 2");
        targets.get(7).setName("Front Perimeter 1");
        targets.get(8).setName("Front Perimeter 2");
        targets.get(9).setName("Blue Perimeter 1");
        targets.get(10).setName("Blue Perimeter 2");
        targets.get(11).setName("Rear Perimeter 1");
        targets.get(12).setName("Rear Perimeter 2");
        ...
        final int CAMERA_FORWARD_DISPLACEMENT  = 90;   // Camera is 110 mm in front of robot center
        final int CAMERA_VERTICAL_DISPLACEMENT = 170;   // Camera is 200 mm above ground
        ...
        OpenGLMatrix phoneLocationOnRobot = OpenGLMatrix
                ...
                .multiplied(Orientation.getRotationMatrix(
                        ...
                        AngleUnit.DEGREES, CAMERA_CHOICE == VuforiaLocalizer.CameraDirection.FRONT ? 75 : -75, 0, 0));
